    ...
    return (
        <div>
			<div className="space-y-4 mx-10 my-16">
				<details
					className="group border-l-4 border-[#1185de] shadow-lg shadow-slate-900 bg-gray-50 p-6"
					open>
				...
				<details className="group border-l-4 border-[#1185de] shadow-lg shadow-slate-900 bg-gray-50 p-6">
					<summary className="flex cursor-pointer items-center justify-between">
						<h2 className=" gap-2 text-lg font-medium text-gray-900 flex items-center justify-center">
							<div className="text-lg">
								<AiFillQuestionCircle></AiFillQuestionCircle>
