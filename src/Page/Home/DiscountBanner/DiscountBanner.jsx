    ...
    return (
        <div className='div lg:py-0 md:py-10 py-20 px-5 mt-20 md:px-10 lg:px-20 bg-slate-100 flex justify-between items-center'>
            <div>
                ...
                {
                    user?.uid ? <Link to='/product'>
                    <button className='flex mt-10 bg-[#1185de] hover:ml-3 hover:bg-[#00589b] rounded-md py-2 px-5'><p className='text-white text-xl'>Start Your Shopping</p><WiDirectionLeft className='text-3xl rotate-180	text-white' /></button>
                </Link> :<Link to='/signup'>
